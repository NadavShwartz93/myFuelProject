...
public class AddClientAssociationWithPurchasePlanModelController implements Initializable {
	

	public ClientHandlerSingle chs;
	public AddCustomerController ac;
	public AddClientAssociationWithPurchasePlanModelController acawp;
	...
	public AddClientAssociationWithPurchasePlanModelController() {
     ...
     * For instance, the method get "Normal Fueling" and return "NormalFueling".
  	 ...
  	 */
    public void backToManageCustomer() {
